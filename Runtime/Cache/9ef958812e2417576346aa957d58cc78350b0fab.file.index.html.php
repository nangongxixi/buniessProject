<?php /* Smarty version Smarty-3.1.6, created on 2017-11-14 11:15:35
         compiled from "D:/phpStudy/WWW/buniessProject/Project/Home/View\wap\index.html" */ ?>
<?php /*%%SmartyHeaderCode:162165a0953fab50048-42828395%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '162165a0953fab50048-42828395',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5a0953fabd4d6',
  'variables' => 
  array (
    'picList' => 0,
    'cnzz' => 0,
...
<?php if ($_valid && !is_callable('content_5a0953fabd4d6')) {function content_5a0953fabd4d6($_smarty_tpl) {?><!DOCTYPE html>
...
alifont/iconfont.css">
    ...
    (function (root) {
        ...
        ta.onerror = function () {
            ...
            var js_url = ta.src;
            var url = '//ad.toutiao.com/link_monitor/cdn_failed?web_url=' + web_url + '&js_url=' + js_url + '&convert_id=74381099680';
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" name="phone" class="form-control input-border"
                                   placeholder="请输入手机号" maxlength="11" style="font-size: 16px"
                                   errorMsg="手机号为1开始的11位纯数字">
                        </div>
                    </div>
...
<!--cnzz统计-->
<?php echo htmlspecialchars_decode($_smarty_tpl->tpl_vars['cnzz']->value);?>
    ...
    $(function () {
        ...
        $('#submit').unbind('click').click(function () {
          ...
          //  var xx = getUrlParam('source');
            ...
            $.ajax({
                url: '/index.php/Home/Wap/add/source/'+source,
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
